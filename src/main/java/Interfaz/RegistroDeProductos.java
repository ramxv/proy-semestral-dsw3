...
public class RegistroDeProductos extends javax.swing.JFrame {
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        Double precioEs = Double.valueOf(precioEstandar.getText());
        Double precioDesc = Double.valueOf(descuento.getText());

        try {
            Connection con = HikariJDBC.getConnection();

            PreparedStatement ps = con.prepareStatement("INSERT INTO productos(codigoBarra, nombre, precioEstandar, precioDescuento) VALUES(?,?,?,?)");
            ps.setString(1, codigo);
            ps.setString(2, nombre);
            ps.setDouble(3, precioEs);
            ps.setDouble(4, precioDesc);
